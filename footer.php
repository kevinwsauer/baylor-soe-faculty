...
?>
    ...
    <div id="footer-2">         
        <footer id="colophon-2" class="site-footer wrapper" role="contentinfo">
            <div class="site-info">
                <a href="<?php echo esc_url( __( 'http://wordpress.org/', 'soe-faculty' ) ); ?>"><?php printf( __( 'Proudly powered by %s', 'soe-faculty' ), 'WordPress' ); ?></a>
                <span class="sep"> | </span>
                <?php printf( __( 'Theme: %1$s by %2$s.', 'soe-faculty' ), 'SOE-Faculty', '<a href="http://www.baylor.edu/soe/" rel="designer">Kevin Sauer, Baylor University School of Education</a>' ); ?>
                <br />
                <br />
