...
add_action('init', 'soe_faculty_fitvids');

// Automatically append .video class to oembed content (not a perfect solution, but close)
function soe_faculty_embed_filter( $html, $data, $url ) {
	$return = '<div class="video">'.$html.'</div>';
	return $return;
}

add_filter('oembed_dataparse', 'soe_faculty_embed_filter', 90, 3 );
