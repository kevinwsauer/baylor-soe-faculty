...
<div id="page" class="hfeed site">
	<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'soe-faculty' ); ?></a>
	<header id="masthead" class="site-header" role="banner">
        <div id="baylor_header">
            <div id="h">
        ...
        <nav id="site-navigation" class="main-navigation" role="navigation">
            <div class="wrapper">
                <button class="menu-toggle"><?php _e( '<i class="fa fa-bars"></i>', 'soe-faculty' ); ?></button>
                <?php soe_faculty_main_menu(); ?>
                <div class="search-toggle">
                    <i class="fa fa-search"></i>
                    <a href="#search-container" class="screen-reader-text"><?php _e( 'Search', 'soe-faculty' ); ?></a>
                </div>   
                <?php soe_faculty_social_menu(); ?>
             </div><!-- .wrapper -->
     	</nav><!-- #site-navigation -->
        ...
        <div id="site-branding">
            <div class="site-branding wrapper">
                ...
                <h2 class="site-description"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h2>
